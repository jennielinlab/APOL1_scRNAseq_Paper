...
##########################################################################################
## Subset G0_IFN_TUN
g0ifntun <- subset(x = combined, idents = "G0_IFN_TUN")

## Subset G1_IFN_TUN
g1ifntun <- subset(x = combined, idents = "G1_IFN_TUN")

g0g1ifntun <- subset(x = combined, idents = c("G0_IFN_TUN", "G1_IFN_TUN"))
gecegec <- subset(x = g0g1ifntun, idents = c("Glomerular Epithelial Cells", "Early GEC"))
Idents(gecegec) <- "stim"

DotPlot(gecegec, features = c("PODXL", "NPHS1", "NPHS2", "PTPRO", "MAFB"), dot.scale=20, cols=c("red", "blue"))
...
## G0_IFN_TUN vs G1_IFN_TUN
avgs <- combined.averages@assays$integrated@scale.data
avgs.df <- as.data.frame(avgs)
test <- avgs.df[c('NPHS1', 'PTPRO', 'MAFB', 'POSTN'), c('G0_IFN_TUN_Mesenchyme', 'G0_IFN_TUN_Glomerular Epithelial Cells',
                                                        'G0_IFN_TUN_Cycling Cells', 'G0_IFN_TUN_Early GEC',
                                                        'G0_IFN_TUN_Proximal and Distal Tubule',
                                                        'G0_IFN_TUN_Endothelial Cells', 'G0_IFN_TUN_Neuron', 'G1_IFN_TUN_Mesenchyme',
                                                        'G1_IFN_TUN_Early GEC', 'G1_IFN_TUN_Cycling Cells',
                                                        'G1_IFN_TUN_Glomerular Epithelial Cells',
                                                        'G1_IFN_TUN_Proximal and Distal Tubule', 'G1_IFN_TUN_Neuron',
                                                        'G1_IFN_TUN_Endothelial Cells')]
